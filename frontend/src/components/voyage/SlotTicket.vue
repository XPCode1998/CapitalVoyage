...
<style scoped>
.slot-ticket{--ticket-page:#07101f;border-color:rgba(119,151,207,.27);background:linear-gradient(145deg,rgba(22,43,75,.94),rgba(10,23,44,.95));box-shadow:0 12px 30px rgba(0,0,0,.25)}.slot-ticket::before,.slot-ticket::after{border-color:rgba(119,151,207,.27);background:var(--ticket-page)}.slot-ticket:hover,.slot-ticket:focus-visible{border-color:rgba(91,139,255,.75);box-shadow:0 14px 38px rgba(17,61,155,.32)}.ticket-number strong{color:#95b9ff}.ticket-number small,.ticket-stub>small,.security span,.voyage-snapshot span,.remaining>span,.ticket-footer span{color:#7890b2}.voyage-title h3,.security b,.remaining strong,.ticket-footer b{color:#edf4ff}.security small{color:#9fb2ce}.ticket-footer,.ticket-stub{border-color:rgba(119,151,207,.2)}.ticket-stub{background:rgba(6,16,32,.18)}.stub-plane{color:#6f91c4}.barcode{background:repeating-linear-gradient(90deg,#89a8d5 0 1px,transparent 1px 3px,#89a8d5 3px 5px,transparent 5px 7px)}.ticket-available{color:#9bb6df}.ticket-available>small{color:#7088aa}.ticket-status.available{color:#aebed4;background:rgba(129,151,182,.16)}
</style>
