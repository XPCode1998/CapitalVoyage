...
@media(max-width:900px){
  .mobile-topbar{position:fixed;inset:0 0 auto;z-index:20;height:calc(58px + env(safe-area-inset-top));display:flex;align-items:flex-end;justify-content:space-between;padding:env(safe-area-inset-top) 16px 10px;background:rgba(8,18,36,.91);border-bottom:1px solid var(--line);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px)}
  .mobile-brand{display:flex;align-items:center;gap:10px;min-width:0}.mobile-brand img{width:31px;height:31px}.mobile-brand>span{min-width:0;display:grid;gap:1px}.mobile-brand b{overflow:hidden;color:#eef5ff;font-size:14px;text-overflow:ellipsis;white-space:nowrap}.mobile-brand small{color:#89a0c2;font-size:7px;font-weight:750;letter-spacing:.12em}
  .mobile-live{display:flex;align-items:center;gap:5px;padding-bottom:7px;color:#a7b9d2;font-size:9px;font-style:normal;font-weight:700;letter-spacing:.04em}.mobile-live span{width:6px;height:6px;border-radius:50%;background:var(--tower-green);box-shadow:0 0 0 3px rgba(57,226,176,.12)}.mobile-live.closed span{background:#8e9aa6;box-shadow:0 0 0 3px rgba(142,154,166,.12)}.mobile-live.stale span{background:var(--approach-amber);box-shadow:0 0 0 3px rgba(227,155,45,.12)}.mobile-live.offline span{background:var(--beacon-red);box-shadow:0 0 0 3px rgba(217,83,79,.12)}.mobile-live.checking span{background:#8e9aa6}
  .mobile-bottom-nav{position:fixed;inset:auto 0 0;z-index:25;width:100%;height:calc(64px + env(safe-area-inset-bottom));display:grid;grid-template-columns:repeat(5,1fr);gap:0;margin:0;padding:5px 6px env(safe-area-inset-bottom);border-top:1px solid var(--line);background:rgba(8,18,36,.95);box-shadow:0 -8px 24px rgba(0,0,0,.26);backdrop-filter:blur(18px);-webkit-backdrop-filter:blur(18px)}
  .mobile-bottom-nav a{position:relative;min-width:0;min-height:0;margin:0;padding:0;display:grid;place-content:center;justify-items:center;gap:2px;border:0;border-radius:10px;color:#8298ba;text-decoration:none}.mobile-bottom-nav a>span{font-size:10px;font-weight:650}.mobile-bottom-nav a>small{font-size:6px;font-weight:700;letter-spacing:.04em}.mobile-bottom-nav a.router-link-active,.mobile-bottom-nav a.returning{color:#eef5ff;background:radial-gradient(circle at 50% 0,#326ff6,rgba(34,79,175,.36) 58%,transparent 74%)}.mobile-bottom-nav a.router-link-active::before,.mobile-bottom-nav a.returning::before{content:"";position:absolute;inset:0 auto auto 50%;width:20px;height:3px;border:0;border-radius:0 0 3px 3px;background:#65a0ff;box-shadow:0 0 10px #4380ff;transform:translateX(-50%)}
}
</style>
