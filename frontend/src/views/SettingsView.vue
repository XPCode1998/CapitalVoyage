...
<style scoped>
.settings-page{max-width:820px;padding-bottom:104px}.settings-page-header{display:flex;align-items:flex-end;justify-content:space-between;gap:20px;margin-bottom:26px}.settings-page-header h1{margin:5px 0 6px;font-size:28px;letter-spacing:-.04em}.settings-page-header p:last-child{margin:0;color:var(--muted-2);font-size:13px}.settings-sync{display:flex;align-items:center;gap:7px;flex:none;color:var(--tower-green);font-size:12px}.settings-sync i{width:7px;height:7px;border-radius:50%;background:currentColor;box-shadow:0 0 0 4px color-mix(in srgb,currentColor 12%,transparent)}.settings-sync.dirty{color:var(--approach-amber)}.settings-groups{display:grid;gap:24px}.settings-group h2{margin:0 0 8px 4px;color:var(--muted-2);font-size:12px;font-weight:650}.settings-list{overflow:hidden;border:1px solid var(--line);border-radius:14px;background:linear-gradient(145deg,rgba(21,40,70,.92),rgba(12,25,47,.9));box-shadow:var(--shadow-ticket)}.setting-row{width:100%;min-height:72px;display:grid;grid-template-columns:38px minmax(0,1fr) auto 18px;align-items:center;gap:12px;padding:12px 14px;border:0;border-bottom:1px solid var(--line-soft);background:transparent;text-align:left}.setting-row:last-child{border-bottom:0}.setting-row:hover{background:rgba(83,124,191,.11)}.setting-icon{width:34px;height:34px;display:grid;place-items:center;border:1px solid rgba(100,148,255,.18);border-radius:10px;color:#7da8ff;background:linear-gradient(145deg,rgba(50,117,255,.32),rgba(32,72,161,.22))}.setting-copy{min-width:0;display:grid;gap:3px}.setting-copy b{color:var(--ink);font-size:14px;font-weight:650}.setting-copy small{overflow:hidden;color:var(--muted-2);font-size:11px;line-height:1.35;text-overflow:ellipsis;white-space:nowrap}.setting-value{max-width:176px;overflow:hidden;color:#b8c9e3;font-size:13px;text-align:right;text-overflow:ellipsis;white-space:nowrap}.setting-arrow{color:#7590b7}.settings-savebar{position:fixed;z-index:20;bottom:20px;left:50%;width:min(650px,calc(100% - 32px));display:flex;align-items:center;justify-content:space-between;gap:16px;padding:12px 14px 12px 18px;border:1px solid rgba(101,149,245,.36);border-radius:14px;background:rgba(13,29,55,.94);box-shadow:0 12px 32px rgba(0,0,0,.35);transform:translateX(-50%);backdrop-filter:blur(12px)}.settings-savebar span{color:#aebfd8;font-size:12px}.setting-editor{display:grid;gap:16px}.setting-editor>label{display:grid;gap:7px}.setting-editor small{color:var(--muted-2);font-size:12px;line-height:1.55}.test-button{justify-self:start}.editor-tip{margin:0;color:var(--approach-amber);font-size:12px}.modal-actions{display:flex;justify-content:flex-end;gap:9px;margin-top:6px;padding-top:16px;border-top:1px solid var(--line-soft)}
